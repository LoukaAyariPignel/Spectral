package fr.skylined.spectral.client.color;
...
public final class WavelengthTintSource implements ItemTintSource {

    public static final WavelengthTintSource INSTANCE = new WavelengthTintSource();
    public static final MapCodec<WavelengthTintSource> CODEC = MapCodec.unit(INSTANCE);

    private WavelengthTintSource() {}
    ...
    public int calculate(ItemStack stack, @Nullable ClientLevel level, @Nullable LivingEntity entity) {
        ...
        if (wavelength < GemItem.MIN_WAVELENGTH || wavelength > GemItem.MAX_WAVELENGTH) return -1;
        return colorFromWavelength(wavelength);
    }
